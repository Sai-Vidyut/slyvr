    ...
    >
      ...
      <div className="relative z-10 flex min-h-0 flex-1 flex-col">
        <div className="mx-auto w-full max-w-[1400px] flex-1 px-4 md:px-8 xl:px-10">
          <div className="grid items-start gap-12 pt-[4.25rem] md:gap-14 md:pt-24 lg:grid-cols-[minmax(0,0.42fr)_minmax(0,0.58fr)] lg:gap-8 lg:pt-28 xl:gap-10 xl:pt-32">
            <m.header
            ...
            >
              ...
              >
                <m.p
                  ...
                  className="text-label mb-5 md:mb-6 md:text-xs lg:mb-7 lg:tracking-[0.2em]"
                >
                ...
                <m.h1
                  ...
                  variants={landingHeroItem}
                  className="text-hero mb-6 max-w-[12ch] sm:mb-7 md:mb-8"
                >
                  Your videos.
                  <br />
                  One archive.
                ...
                >
                  Upload everything you care about — or only what you keep watching. Search by title,
                  category, or person. Your library stays yours.
                </m.p>
                <m.div
                  variants={landingHeroItem}
                  className="mt-9 flex flex-wrap items-center gap-3 md:mt-10 lg:mt-11"
                >
                  <m.div whileHover={reduced ? undefined : buttonHover} whileTap={reduced ? undefined : buttonTap}>
                    <Link
                      to="/app"
                      className="inline-flex min-h-11 items-center gap-2 rounded-full bg-[var(--clip-accent)] px-6 py-2.5 text-sm font-medium text-[var(--clip-accent-fg)] focus-visible:outline-none focus-visible:ring-1 focus-visible:ring-[var(--clip-focus)] md:min-h-12 md:px-7 md:text-base"
                    >
                      Open your library
                  ...
                  <m.button
                    ...
                    className="inline-flex min-h-11 items-center rounded-full border border-[var(--clip-border)] px-5 py-2.5 text-sm text-[var(--clip-fg)] hover:border-[var(--clip-border-strong)] focus-visible:outline-none focus-visible:ring-1 focus-visible:ring-[var(--clip-focus)] md:min-h-12 md:px-6 md:text-base"
                  >
                    See how it works
                  </m.button>
                </m.div>
                <m.div variants={landingHeroItem} className="mt-14 flex items-center gap-4 md:mt-16 lg:mt-[4.5rem]">
                  <div className="h-px w-12 bg-[var(--clip-border-strong)] md:w-14 lg:w-16" aria-hidden />
        ...
        <m.div
          ...
          className="relative z-10 mt-auto w-full pt-10 sm:pt-14 md:pt-16 lg:pt-20 xl:pt-24"
        >
          <LandingMarquee wide />
          <div className="mx-auto flex max-w-6xl justify-end px-4 pb-6 pt-5 md:px-8 md:pb-8">
